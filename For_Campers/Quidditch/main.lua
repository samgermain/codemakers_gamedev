...
function love.load()
	...
	objects.ground = {}
	objects.ground.x = 1700/2 	-- The x position of the ground
	objects.ground.y = 1000-50  -- The y position of the ground
...
------------------------------------------------------------------------------------------------------------------------------------------------
	...
	love.graphics.rectangle("fill", objects.ground.x - 850, objects.ground.y, objects.ground.width, objects.ground.height) 
-------------------------------------------------------------------------------------------------------------------------------------------------
