...
---------------------------------------------------------------------------------------------------------------------------------------------------------------		
		...
		oldx = 0	--Change the value on the right
		oldy = 0	--Change the value on the right
---------------------------------------------------------------------------------------------------------------------------------------------------------------	
...
function love.keypressed(button)
	...
	elseif button == "r" then
		objects.ball.body:setPosition(1650, 50)
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	--Create a for loop that will loop through objects.lines and print each line stored in it. Check the code for the quidditch game(5 day camps) and see how multiple hoops are drawn in a loop. 
