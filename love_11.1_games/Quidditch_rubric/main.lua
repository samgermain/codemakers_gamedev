...
function love.load()
	paused = false	--This variable determines if the game is paused or not
	...
	objects.ground = {}
	objects.ground.x = 1500/2 	-- The x position of the ground
	objects.ground.y = 750-50  -- The y position of the ground
...
-----------
--I've created a bunch of ramps and hoops below, I did it similar to how you created the ground in the last game, so I didn't want to make you code all this up on your own and just did it for you
-----------
	objects.ramps = {}
	ramp = {}
	ramp.x = 1650
	...
	love.window.setMode(1500, 750) --set the window dimensions to 650 by 650
end
...
---------------------------------------------------------------------------------------------------------------------
	...
	elseif love.keyboard.isDown("r") then --press the up arrow key to set the wizard back to the start
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		love.graphics.polygon('fill', ramp.x, ramp.y, ramp.x2, ramp.y, ramp.x2, ramp.y2)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------		
...
------------------------------------------------------------------------------------------------------------------------------------------------
	...
	love.graphics.rectangle("fill", objects.ground.x - 750, objects.ground.y, objects.ground.width, objects.ground.height) 
-------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	x_pos = objects.wizard.body:getX() 
	y_pos = objects.wizard.body:getY()
----------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	love.graphics.draw(img, x_pos, y_pos, angle, scale_width, scale_height, orient_x, orient_y )	-- draws the wizard onto the screen
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		love.graphics.draw(hoop.img, hoop.x, hoop.y/2, 0, 2)
-----------------------------------------------------------------------------------------------------------------------------------------------------------
